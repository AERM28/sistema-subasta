...
class AuctionModel
{
    ...
    /* Detalle completo: subasta + objeto con imágenes, categorías + historial de pujas */
    ...
    {
        $vSql = "SELECT a.id, a.start_at, a.end_at, a.base_price, a.min_increment, ast.name AS status_name," .
                " (SELECT COUNT(*) FROM bid b WHERE b.auction_id = a.id) AS total_bids" .
